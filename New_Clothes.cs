...
namespace IT123P___MP
{
    ...
    public class New_Clothes : Activity
    {
        ...
        public void SaveImage()
        {
            if (imageUri == null)
            { return; }
            string url = "http://192.168.100.63/REST/IT123P/MP/API/save_clothe_item.php";
        ...
        public void Submit()
        {
            ...
            request = (HttpWebRequest)WebRequest.Create($"http://192.168.100.63/REST/IT123P/MP/API/Change_Name.php?name={fileName}&type={type}");
